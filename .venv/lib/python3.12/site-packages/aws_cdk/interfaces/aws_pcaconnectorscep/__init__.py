...
class ChallengeReference:
    def __init__(self, *, challenge_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__f42f3eded91548c5cdf6356bdbb15dc2560cdc2a1771659684ac1fa382f9f1fb)
...
class ConnectorReference:
    def __init__(self, *, connector_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__1486192b1d2e48e8a3a7c89fff86f9653db0e71de2ca530880d5b6ed21a6017d)
