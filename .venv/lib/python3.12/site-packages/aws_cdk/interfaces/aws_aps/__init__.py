...
class AnomalyDetectorReference:
    def __init__(self, *, anomaly_detector_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__8713accc66b6c1a4a61b78d26bd833761032f548f0c6d01a445c484902f3b26b)
...
class ResourcePolicyReference:
    def __init__(self, *, workspace_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__f0f24d8ab317c40a83230f293fadb89964bbc2927faa60441cac5180eb7b4008)
...
class RuleGroupsNamespaceReference:
    def __init__(self, *, rule_groups_namespace_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__7babc091249b2b8f07528284ae1ae6c847c2d6a98e06c8e8811e4425107ed0a9)
...
class ScraperReference:
    def __init__(self, *, scraper_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__b691c6ec24da852c7fa2138c93c6c122fe42f78d55b29bd6a4dab6f23fbb2a21)
...
class WorkspaceReference:
    def __init__(self, *, workspace_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__1e288d1d5d6e00c7cdc3a91d4e4e579a062e4c6d0cf48b6f3cbc3dd8acf598b7)
            check_type(argname="argument workspace_arn", value=workspace_arn, expected_type=type_hints["workspace_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "workspace_arn": workspace_arn,
        }
