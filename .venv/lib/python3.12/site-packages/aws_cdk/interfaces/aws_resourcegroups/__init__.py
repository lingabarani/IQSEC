...
class GroupReference:
    def __init__(self, *, group_arn: builtins.str, group_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__de96f869c9839fec47adcfb2b629bd6ec6748bdb184fe9309c855ff3375594ed)
...
class TagSyncTaskReference:
    def __init__(self, *, task_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__e7be762e0fa2ae57c29d2b33464ecdd38a60f5cd0ab37eaf86f0b039c8306af1)
