...
class ScalableTargetReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__79b0d23171b4fcbed5c9ae0a8a7c14eea7aa845c597a7df4ed09f50c065bb4dd)
...
class ScalingPolicyReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__498c5015ed26a2b8e991461356d344690b175358634465fb173ebd5f71bb3d27)
            check_type(argname="argument scalable_dimension", value=scalable_dimension, expected_type=type_hints["scalable_dimension"])
