...
class ClusterReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__05406601d1a4f85ebaa2850ac9c6ac421d1ad692fb7d01bf8a326a3953f7e38b)
...
class ParameterGroupReference:
    def __init__(self, *, parameter_group_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__c7df59dc4674887428e9aabb0ae3c8f44947489e82e8fc231fc079e8886664f1)
...
class SubnetGroupReference:
    def __init__(self, *, subnet_group_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__a9a0c3f06e1935cdf153ef5db387147d3c9ee2f0e536009e9e281f2ae65366ed)
