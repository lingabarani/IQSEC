...
class CRLReference:
    def __init__(self, *, crl_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__916ec2d2aae5ecd1575ceef844e6bfb54c8909e4505f26fc504bb20a36638078)
...
class ProfileReference:
    def __init__(self, *, profile_arn: builtins.str, profile_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__1ca44262455fa0fcdcf355663380e4b88f61ee6a7c456ed6594ecfc33f16c5da)
...
class TrustAnchorReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__219d4bcadedca24e22886d453073aaa28b70678fe7cefdfdc821bb719ffb99e0)
