...
class AlertReference:
    def __init__(self, *, alert_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__b0174632c125fced856edd39640dbde3d250284032b3c662039d9ab935bd4677)
...
class AnomalyDetectorReference:
    def __init__(self, *, anomaly_detector_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__a7b49b95901b1b5a14c5b6e2caedb2b40a4cee9806cb52f9cf1a8ee489c402dc)
