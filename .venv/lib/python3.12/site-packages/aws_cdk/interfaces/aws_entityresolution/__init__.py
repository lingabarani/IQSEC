...
class IdMappingWorkflowReference:
    def __init__(self, *, workflow_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__37caac4f4b69db6d5f1130f5dc1b860f7214f7b71ef8c26965be0267e3b4a3ca)
...
class IdNamespaceReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__84946b161214154ee5fbee7ff1dfd58709fc4c388198fdae9f58349ce8f7de36)
...
class MatchingWorkflowReference:
    def __init__(self, *, workflow_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__8e14699b90393c25e0943578c10660c5d654fd6e1eba00d305dd38017a8cde25)
            check_type(argname="argument workflow_name", value=workflow_name, expected_type=type_hints["workflow_name"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "workflow_name": workflow_name,
        }
...
class PolicyStatementReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__6bfd6a0aa4cd92acd08d9aeddac23127972b6b8985b144c45122a8f1d1d962d0)
...
class SchemaMappingReference:
    def __init__(self, *, schema_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__2a833940eaa015fb2ddf4f62f8edf18d654bad5c95b977d78202bf6b5bd0929c)
