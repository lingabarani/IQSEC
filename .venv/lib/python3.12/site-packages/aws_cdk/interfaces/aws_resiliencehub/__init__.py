...
class AppReference:
    def __init__(self, *, app_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__3cb61fa3c20dcbe83a92f4ce83d1c1e8ab107f3593a79fcdd68c7997d55cbac7)
...
class ResiliencyPolicyReference:
    def __init__(self, *, policy_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__858c1cc5b4c4e16bc1082dfc336cca315132234ba3d88ac972d29352636242ea)
