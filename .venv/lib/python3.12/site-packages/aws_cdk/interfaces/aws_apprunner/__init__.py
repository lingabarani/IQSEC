...
class AutoScalingConfigurationReference:
    def __init__(self, *, auto_scaling_configuration_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__b23311553dbebbf746f39eeee73f382a361dfb4ec7ca9ba4d02d9c1ed64f8a41)
...
class ObservabilityConfigurationReference:
    def __init__(self, *, observability_configuration_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__10ecefea892e5ef185bf208418555683f7e742ba9406e739995117075f499eab)
...
class ServiceReference:
    def __init__(self, *, service_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__0bbb56cbe5c4f3b4a1f82fee24b81285757c9e31ac24f28c2174c61b78764d16)
...
class VpcConnectorReference:
    def __init__(self, *, vpc_connector_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__2a5736d3b7a952404839f327bd5a27112dbd098bf3b1cb8032c1181e0fad204c)
...
class VpcIngressConnectionReference:
    def __init__(self, *, vpc_ingress_connection_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__089bc7f9cb92ee68b27c295c044cbe69aee00d63ad614c03f1fb09081ec0c831)
