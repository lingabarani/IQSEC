...
class SubscriptionReference:
    def __init__(self, *, subscription_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__89cf0bf2547ca6929244d1f37c0dce591f5c5a0cc8f04eeb7aa817f5a463a51f)
...
class TopicInlinePolicyReference:
    def __init__(self, *, topic_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__eb085fa38430c5cfa8747237294a4dc3de6a403dd402472cc5a4d131c8e84903)
...
class TopicPolicyReference:
    def __init__(self, *, topic_policy_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__a5649e84d5e7a6193ba61637cd7fec19395734081b8ba7aa185c5831c66686c8)
...
class TopicReference:
    def __init__(self, *, topic_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__0c49feb8183d28563dfe0d2424bf0e31d642a7c2b5e59b3a2a56f21a037c9336)
            check_type(argname="argument topic_arn", value=topic_arn, expected_type=type_hints["topic_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "topic_arn": topic_arn,
        }
