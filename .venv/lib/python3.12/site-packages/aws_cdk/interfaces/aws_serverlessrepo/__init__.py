...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_serverlessrepo.ApplicationReference",
    jsii_struct_bases=[],
...
class ApplicationReference:
    def __init__(self, *, application_id: builtins.str) -> None:
        ...
        Example::
            ...
            from aws_cdk.interfaces import aws_serverlessrepo as interfaces_serverlessrepo
            
            application_reference = interfaces_serverlessrepo.ApplicationReference(
                application_id="applicationId"
            )
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__3d8f72be756ab86f257fc27c2d9c6868a06d0cfb850d283a99def4ac7b98ceff)
...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_serverlessrepo.IApplicationRef")
...
class _IApplicationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_serverlessrepo.IApplicationRef"
...
def _typecheckingstub__3d8f72be756ab86f257fc27c2d9c6868a06d0cfb850d283a99def4ac7b98ceff(
    *,
