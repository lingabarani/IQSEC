...
class CapabilityReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__e6a2e713a60e2fb71716a0df56c864fe973cc3b50fabe2de48c98f74f6f0bce1)
...
class PartnershipReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__7c687603cc7d0acc0f23a4ca99e3f0df0b1bc82d6783113da186d59156d95882)
...
class ProfileReference:
    def __init__(self, *, profile_arn: builtins.str, profile_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__277efee3c1b4f9109a4066cc871dc08b73bf9f1b20febefe61b2f996c14d0180)
...
class TransformerReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__68f8457e823d166b77ba434475d778e2f7ce6a5eff2edd07b9978da7bfc984ea)
