...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_transfer.HostKeyReference",
    jsii_struct_bases=[],
    name_mapping={"host_key_arn": "hostKeyArn"},
)
class HostKeyReference:
    def __init__(self, *, host_key_arn: builtins.str) -> None:
        '''A reference to a HostKey resource.

        :param host_key_arn: The Arn of the HostKey resource.
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__655ac5c0b0ef8d8129e56bdea1c945f2da5cbe8a7531ca365104dfef327a4b0b)
            check_type(argname="argument host_key_arn", value=host_key_arn, expected_type=type_hints["host_key_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "host_key_arn": host_key_arn,
        }

    @builtins.property
    def host_key_arn(self) -> builtins.str:
        '''The Arn of the HostKey resource.'''
        result = self._values.get("host_key_arn")
        assert result is not None, "Required property 'host_key_arn' is missing"
        return typing.cast(builtins.str, result)
    ...
    def __repr__(self) -> str:
        return "HostKeyReference(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.interface(jsii_type="aws-cdk-lib.interfaces.aws_transfer.IHostKeyRef")
class IHostKeyRef(
    _constructs_77d1e7e8.IConstruct,
    _interfaces_8ca7e747.IEnvironmentAware,
    typing_extensions.Protocol,
):
    '''(experimental) Indicates that this resource can be referenced as a HostKey.
    ...
    def host_key_ref(self) -> "HostKeyReference":
        '''(experimental) A reference to a HostKey resource.
...
class _IHostKeyRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_transfer.IHostKeyRef"
    ...
    def host_key_ref(self) -> "HostKeyReference":
        ...
        :stability: experimental
        '''
        return typing.cast("HostKeyReference", jsii.get(self, "hostKeyRef"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IHostKeyRef).__jsii_proxy_class__ = lambda : _IHostKeyRefProxy
...
def _typecheckingstub__655ac5c0b0ef8d8129e56bdea1c945f2da5cbe8a7531ca365104dfef327a4b0b(
    *,
    host_key_arn: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
for cls in [IAgreementRef, ICertificateRef, IConnectorRef, IHostKeyRef, IProfileRef, IServerRef, IUserRef, IWebAppRef, IWorkflowRef]:
