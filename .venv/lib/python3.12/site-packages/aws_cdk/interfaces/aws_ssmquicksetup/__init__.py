...
class ConfigurationManagerReference:
    def __init__(self, *, manager_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__fd9c5ba99f12b20e7873d59bb2772ed2daac536bcf43b84d8de848b0faba8c67)
...
class LifecycleAutomationReference:
    def __init__(self, *, association_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__ba44de012a17ba74c83b063dc9de1699921b659975aba2d2d6d8e3c18212b67d)
