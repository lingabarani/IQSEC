...
class QueueInlinePolicyReference:
    def __init__(self, *, queue: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__459eaf07910b8b59d59b589c04159ce4824d3873eb821449fccb810bc69946d5)
...
class QueuePolicyReference:
    def __init__(self, *, queue_policy_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__553c34733710cc11b4a73ad74d1a85bd5e2cea05d27b8a723847ea2a61f80ef3)
...
class QueueReference:
    def __init__(self, *, queue_arn: builtins.str, queue_url: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__8b79780c1c2cc7db23bb1950ad51f4452bf282a738a20f08da924c777ec4c171)
