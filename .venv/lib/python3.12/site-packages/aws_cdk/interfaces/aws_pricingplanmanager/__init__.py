...
@jsii.interface(
    jsii_type="aws-cdk-lib.interfaces.aws_pricingplanmanager.ISubscriptionRef"
)
...
class _ISubscriptionRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.interfaces.aws_pricingplanmanager.ISubscriptionRef"
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.interfaces.aws_pricingplanmanager.SubscriptionReference",
    jsii_struct_bases=[],
...
class SubscriptionReference:
    def __init__(self, *, subscription_arn: builtins.str) -> None:
        ...
        Example::
            ...
            from aws_cdk.interfaces import aws_pricingplanmanager as interfaces_pricingplanmanager
            
            subscription_reference = interfaces_pricingplanmanager.SubscriptionReference(
                subscription_arn="subscriptionArn"
            )
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__79c4e9a623c46305bd167509f3c708b052be8d1ef3677a7523737ea42fe0ae8a)
...
def _typecheckingstub__79c4e9a623c46305bd167509f3c708b052be8d1ef3677a7523737ea42fe0ae8a(
    *,
