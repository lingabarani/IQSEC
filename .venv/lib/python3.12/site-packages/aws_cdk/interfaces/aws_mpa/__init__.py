...
class ApprovalTeamReference:
    def __init__(self, *, approval_team_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__fb827691e116abc15c72115b6794a63e52afb6f97d7d3d73b4c9d6f9de8ffe41)
...
class IdentitySourceReference:
    def __init__(self, *, identity_source_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__123592926dad4bbf6c98d1e1274b2a10c87fde0ca416b42fdb327d8ddcd1812e)
