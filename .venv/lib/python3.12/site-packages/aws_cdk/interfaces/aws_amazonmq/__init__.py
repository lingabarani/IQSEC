...
class BrokerReference:
    def __init__(self, *, broker_arn: builtins.str, broker_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__e7d08349f61fc490387b85ccf5a6eb11eb8a3d49c1f4ba826886363e86a23921)
...
class ConfigurationAssociationReference:
    def __init__(self, *, configuration_association_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__70bf962895c64c8a2e129db032a13df81d4e347faf07b4624eb97b9c35103c9e)
...
class ConfigurationReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__d8917d10bff03fbb5e9fa4d782baed352b8ca363bfbeaeb9e2263ec9859fd491)
