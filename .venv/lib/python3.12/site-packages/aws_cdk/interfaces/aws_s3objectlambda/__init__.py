...
class AccessPointPolicyReference:
    def __init__(self, *, object_lambda_access_point: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__909a661757d989e0befef656781ae2b5e97361787fabf9a767ed6ec028d9caa2)
...
class AccessPointReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__b16c8e6440e9841e7612789b0a7521eb3e03486c4222cf27a954c084bdb95bd7)
