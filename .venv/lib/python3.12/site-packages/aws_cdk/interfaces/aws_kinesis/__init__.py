...
class ResourcePolicyReference:
    def __init__(self, *, resource_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__fc8b8026038243f2a82e78ac417c2745222bcec45406ef7cd33042584c0499dd)
...
class StreamConsumerReference:
    def __init__(self, *, consumer_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__4ddde013fbaae2b35c3b65e40d19fc082d5fbb082ebd16269678ff8ab218e7b8)
...
class StreamReference:
    def __init__(self, *, stream_arn: builtins.str, stream_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__a89c24e0df4bcb2183d6d3bcf92b9d89d9bab43c08e28b678309d4dab937f9b4)
