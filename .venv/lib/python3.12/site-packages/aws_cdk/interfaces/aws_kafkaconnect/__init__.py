...
class ConnectorReference:
    def __init__(self, *, connector_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__62ca535c7b68a85cfb613cc0df34a54de7f31244f168630b4dfddaedc01b3033)
...
class CustomPluginReference:
    def __init__(self, *, custom_plugin_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__5d9cbfbfa9de008ffc5c1ac1a21fc52f30a3cf75e8f9199867e36522b2371b88)
...
class WorkerConfigurationReference:
    def __init__(self, *, worker_configuration_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__78ace45728fbb4be69948c030d6e0b04a230109b3a5385ecf42d9539bfc61a70)
