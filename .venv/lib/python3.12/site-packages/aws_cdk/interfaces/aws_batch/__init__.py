...
class ComputeEnvironmentReference:
    def __init__(self, *, compute_environment_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__9892f46319fee3a567a6dd9e3467be2ed38db4f5f461dd27c0fc11f2560566ac)
...
class ConsumableResourceReference:
    def __init__(self, *, consumable_resource_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__efae255fc2224f92988a48a3e484cd67fe6c4ec91ce5e9c6fed9a015b90b5c26)
...
class JobDefinitionReference:
    def __init__(self, *, job_definition_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__03d6fd2ef98b3bbd19b585886fbfc0882ccef6244aa7d36aaded401eb007a47f)
...
class JobQueueReference:
    def __init__(self, *, job_queue_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__f741a3233b35e5b1fc106c1afb13f1a1cd2fdd8c9475679574235a13d2be1525)
...
class QuotaShareReference:
    def __init__(self, *, quota_share_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__7f296255df633634241d5f4948791adc26c7ea017fededc933d5a45a02eb3dd9)
...
class SchedulingPolicyReference:
    def __init__(self, *, scheduling_policy_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__55dd4b778d4201026db0389e824b4eb31db89ab05e34ef6d6631ca81ce59f232)
...
class ServiceEnvironmentReference:
    def __init__(self, *, service_environment_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__4a7595da09bf52fb20ecdcaaf1d2bf46051a9c20cb746bfb3a793d6c4b143f7e)
