...
class ApplicationInstanceReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__5e6dfaa8f537f90aa738e82382bd835aeb181bd9d40328bc04994dc253d685f8)
...
class PackageReference:
    def __init__(self, *, package_arn: builtins.str, package_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__605f9abe0963dfdef5a4c1848987a62e79ae98f13697abc2b2af77153e3391ef)
...
class PackageVersionReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__a03fa07d03ba5a5975cf882c650b846855e6c7a271fc90267dc94589fb751155)
            check_type(argname="argument package_id", value=package_id, expected_type=type_hints["package_id"])
