...
class AwsLogSourceReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__1400264d7b65d0f09b4e71ee0568106ff533e33049fdc7a3e8f5609544b16fee)
...
class DataLakeReference:
    def __init__(self, *, data_lake_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__05506121f92ba81a85ad1a4f98ae21ba572c13637d74188809bfd6b68a8879fc)
...
class SubscriberNotificationReference:
    def __init__(self, *, subscriber_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__31232187ee4c0f248cbe10f5a9af57504b391973bd54bed246386f75669c3c4e)
...
class SubscriberReference:
    def __init__(self, *, subscriber_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__fafcdb804bbd83bec7d9b6f23eb86184c7e57df80dc96235abceadd473640c23)
            check_type(argname="argument subscriber_arn", value=subscriber_arn, expected_type=type_hints["subscriber_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "subscriber_arn": subscriber_arn,
        }
