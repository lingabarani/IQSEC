...
class BudgetReference:
    def __init__(self, *, budget_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__fbf38005d31383f8da3fcdbfe0e80cca4ecfcedaf51670b2b4e5dddd34ae4f8b)
...
class BudgetsActionReference:
    def __init__(self, *, action_id: builtins.str, budget_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__ad1aa157838d1188ac808e2eb0e04de265579da58ef5fb71dc35563bee072553)
