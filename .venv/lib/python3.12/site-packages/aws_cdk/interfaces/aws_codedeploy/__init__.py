...
class ApplicationReference:
    def __init__(self, *, application_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__418c8f26c4d68b972ebffadc2241204b3326ab58afc0941988bf813d3f798885)
...
class DeploymentConfigReference:
    def __init__(self, *, deployment_config_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__3f5f932da1842dc9d191290d12508917bcda09a6cf6732df837bea4171333d29)
...
class DeploymentGroupReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__c560dfbd151d8fb2d2f16ee5760ff9916205046ef068a01bf7cbad08a59f075f)
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
