...
class ChannelGroupReference:
    def __init__(self, *, channel_group_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__99924e78ca2a4d8adabc019160be260ec6b23d89acdfbe75931a04e4b2481238)
...
class ChannelPolicyReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__39c79d2d8a36e2f448c2e9bcc20085e56a4c013770464b08f6fe065436ed858c)
...
class ChannelReference:
    def __init__(self, *, channel_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__e732e0925992b2d33f6eaaf633b6bf398af46820b1473b7637d1a0afb5206d9e)
...
class OriginEndpointPolicyReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__5e3d421537158c7e68c3c3ee992e39ba62d0b1457471667b2c9a1fe1d63ed729)
            check_type(argname="argument channel_group_name", value=channel_group_name, expected_type=type_hints["channel_group_name"])
            check_type(argname="argument channel_name", value=channel_name, expected_type=type_hints["channel_name"])
...
class OriginEndpointReference:
    def __init__(self, *, origin_endpoint_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__986e99cfc6c05e847589a9fe3fcd6145bb56221bd4038e96bd8bcffbdfb6817f)
