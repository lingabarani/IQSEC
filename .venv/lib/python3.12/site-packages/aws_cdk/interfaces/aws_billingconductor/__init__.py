...
class BillingGroupReference:
    def __init__(self, *, billing_group_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__7d54d769b9fe153f3708e0f786510d168a65abb45df05c7ee52aec2f9dc1df4a)
...
class CustomLineItemReference:
    def __init__(self, *, custom_line_item_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__0a82dc4016ab3a9b979788b90a66c24114f2e92c31de7e50729b715f8f25fba9)
...
class PricingPlanReference:
    def __init__(self, *, pricing_plan_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__960acf25d202e1e2af55f5a5486c9581bf43462e420a2bb571581e33d90d89fa)
...
class PricingRuleReference:
    def __init__(self, *, pricing_rule_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__2e77af8ffff79b80d2d85e8f1c2cca957ed086ed0f75da346afd52cb5e2d7741)
