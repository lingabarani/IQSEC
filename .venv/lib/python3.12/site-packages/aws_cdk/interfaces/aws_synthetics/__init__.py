...
class CanaryReference:
    def __init__(self, *, canary_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__cfd065f0c9658eada75bb354bd0cabf0d37665555e9a8a1b313f029fc8182f67)
...
class GroupReference:
    def __init__(self, *, group_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__2cb562236ae8f3ba69e52d59927534399c59f90c1a1d58dd69cf8e1087782697)
